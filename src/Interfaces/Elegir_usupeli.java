...
public class Elegir_usupeli extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Elegir_usupeli
     */
    JFreeChart Grafica3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Elegir_usupeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Elegir_usupeli dialog = new Elegir_usupeli(new javax.swing.JFrame(), true);
