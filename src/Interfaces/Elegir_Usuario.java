...
public class Elegir_Usuario extends javax.swing.JDialog {
    ...
    /**
     * Creates new form Elegir_Usuario
     */
    JFreeChart Grafica3;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Elegir_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Elegir_Usuario dialog = new Elegir_Usuario(new javax.swing.JFrame(), true);
